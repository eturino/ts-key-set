...
export function isKeySetSerializedOfStrings(x: KeySetSomeSerialized<Key>): x is KeySetSomeSerialized<string>;
...
export function isKeySetSerializedOfNumbers(x: KeySetSomeSerialized<Key>): x is KeySetSomeSerialized<number>;
